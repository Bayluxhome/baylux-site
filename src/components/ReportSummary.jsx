  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 12, flexWrap: "wrap" }}>
        ...
        ) : <span style={{ color: "var(--ink-soft)", fontSize: 13 }}>{t("mg_no_data_yet")}</span>}
      </div>
      ...
      {cur && cur.note && <div style={{ marginTop: 10, color: "var(--ink-soft)", fontSize: 13, whiteSpace: "pre-line" }}>📝 {cur.note}</div>}
