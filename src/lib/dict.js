...
export const DICT = {
  ru: {
    ...
    bulk_xlsx: "Таблица Excel (.xlsx) *", bulk_zip: "Архив с фото (.zip)",
  ...
  en: {
    ...
    bulk_xlsx: "Excel file (.xlsx) *", bulk_zip: "Photo archive (.zip)",
  ...
  ka: {
    ...
    bulk_xlsx: "Excel-ფაილი (.xlsx) *", bulk_zip: "ფოტოარქივი (.zip)",
