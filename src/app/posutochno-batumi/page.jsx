...
export async function generateMetadata() {
  ...
  return {
    title: t("pb_mt"),
    description: t("pb_md"),
    alternates: altFor(lang, "/posutochno-batumi"),
    openGraph: { title: t("pb_mt"), description: t("pb_md"), type: "website", url: withLang(lang, "/posutochno-batumi"), images: ["/hero-batumi.jpg"] },
  };
}
