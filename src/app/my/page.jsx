    ...
    return (
      <div className="wrap" style={{ padding: "48px 0", maxWidth: 560 }}>
        ...
        <p style={{ color: "var(--ink-soft)", fontSize: 13, marginTop: 20 }}>
          Объявления добавляются в боте <b>@baylux_bot</b> (команда /start или меню).
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="wrap" style={{ paddingBlock: "30px 50px" }}>
      ...
      <p style={{ color: "var(--ink-soft)", margin: "6px 0 20px" }}>
        {session.name ? session.name + ", в" : "В"}аши объекты ({rows.length}). Добавить новый — в боте <b>@baylux_bot</b> (/start).
      </p>
